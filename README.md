# terraform-aws-named-subnets [![Build Status](https://travis-ci.org/cloudposse/terraform-aws-named-subnets.svg?branch=master)](https://travis-ci.org/cloudposse/terraform-aws-named-subnets)
...
| `nat_enabled`                 |                                                 `true`                                                 | Flag of creation `NAT Gateway`                                                                                                                      |    No    |
